...
struct Localization {
    struct ValidateTicketViewController {
        static let Title = NSLocalizedString("BackstageSCAN", comment: "")
    ...
    struct WelcomeViewController {
        ...
        static let Explanation = NSLocalizedString("BackstageSCAN is an event entry app that you can use to validate tickets that you sold through pretix.", comment: "")
